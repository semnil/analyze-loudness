...
(function () {
  ...
  const DICT = {
    en: {
      ...
      "tip.chart_histogram": "Distribution of loudness samples (bin width 0.5 LUFS, density normalised, range -55 to -5 LUFS). The accent line marks the integrated loudness; the dashed line marks the median. Frames below -60 LUFS (silence) are excluded.",
      "tip.chart_segments": "Per 5-minute segment short-term loudness average with P10-P90 error bars. The dashed accent line shows the integrated loudness reference; segments without samples above -60 LUFS appear empty.",
    },
    ja: {
      "app.title": "Loudness Analyzer (BS.1770 / EBU R128)",
      "form.aria": "音声ソースを分析",
      ...
      "tip.chart_histogram": "ラウドネス分布のヒストグラム (ビン幅 0.5 LUFS、密度正規化、-55〜-5 LUFS)。アクセント色の縦線は Integrated、点線は中央値を示す。-60 LUFS 未満の無音フレームは除外。",
      "tip.chart_segments": "5 分単位セグメントの Short-term ラウドネス平均と P10-P90 エラーバー。点線は Integrated 基準。-60 LUFS を超えるサンプルが存在しないセグメントは空欄になる。",
    },
  };
